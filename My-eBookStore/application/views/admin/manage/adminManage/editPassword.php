...
<form action='<?php echo DOMAIN . "index.php?p=admin&c=admin&a=editpassword"; ?>' method="post" id="form_edit_password" onsubmit="return editPassword()" class="form-horizontal" role="form">
