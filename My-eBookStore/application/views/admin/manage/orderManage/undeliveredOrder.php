...
foreach($undeliveredOrders as $myOrder) {
    ...
    echo          '</tbody>
          ...
          <div class="panel-footer">
              <a id="delivery_' . $myOrder[0][FIELD_ORDER_PK] . '" class="delivery_order" href="javascript:void(0);">发货</a>&nbsp;&nbsp;
              <a id="delete_' . $myOrder[0][FIELD_ORDER_PK] . '" class="delete_order" href="javascript:void(0);">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
