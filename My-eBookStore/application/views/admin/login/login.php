...
<body>
  ...
  <div id="main" class="container">
    <h2 class="text-center" style="padding:20px;">管理员登录</h2>
    <hr />
    <form action='<?php echo DOMAIN . "index.php?p=admin&c=guest&a=login"; ?>' method="post" class="form-horizontal" role="form">
      <div class="form-group">
        <label for="login_username" class="col-xs-2 col-xs-offset-2 col-sm-2 col-sm-offset-3 col-md-2 col-md-offset-3 control-label">用户名</label>
        <div class="col-xs-5 col-sm-4 col-md-3">
          <input type="text" id="login_username" name="login_adminname" class="form-control" placeholder="用户名" required autocomplete="off" />
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-xs-5 col-sm-4 col-md-3">
          <input type="password" id="login_password" name="login_adminpass" class="form-control" placeholder="密码" required autocomplete="off" />
        </div>
